    ...
    <section className="min-h-screen py-16 w-full flex h-full">
      <div className="max-w-screen-xl  justify-center items-center flex-1 flex md:flex-row flex-col mx-auto  min-h-full">
        ...
        >
          ...
          <Link
            href={"/contact"}
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded bg-primary hover:-translate-y-1 hover:bg-primary-foreground transition focus:ring-4 focus:ring-blue-300 w-fit dark:focus:ring-blue-900"
          >
            {data.contactText}
          </Link>
        </AnimatedDiv>
